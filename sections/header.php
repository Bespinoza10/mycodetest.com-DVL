<div class="container-fluid">
  <div class="col-md-1 center-column">
    <img class="img-responsive top-logo" src="img/logo.svg">
  </div>
</div>

<header class="home-bg vertical-align">
  <div class="col-md-8 center-column header-text">
    ...
    <div class="col-md-10 center-column header-text-two">
    ...
    <div class="col-md-4 header-btn-section center-column">
