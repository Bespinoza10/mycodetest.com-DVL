<nav class="navbar navbar-default" role="navigation">
    ...
    <a class="navbar-brand" href="#"><img class="nav-logo" src="img/logo.svg" /></a>
...
<header class="home-bg">
  ...
  <div class="bg-text-container col-sm-12 col-md-12 col-lg-12">
    <div class="bg-text col-sm-12 col-md-10 col-lg-10 center-column">
      <h2 class="bg-second-title center-text">BUSINESS PROCESS SOLUTIONS THAT</h2>
      <h1 class="bg-title center-text">ACCELERATE YOUR GROWTH.</h1>
